...
<p align="center">
  <strong>$2.9 billion in scholarships go unclaimed every year in US alone.</strong><br/>
...
My name is Rasheed. I'm a Petroleum Engineering student at the University of Ibadan, Nigeria. I was supposed to graduate on December 13th, 2025 — five years of work, a 3.4/4.0 GPA, Google Developer Student Clubs Mobile Lead, and volunteer instructor. On paper, I checked every box.

Then my family's income dropped 60% overnight. I watched my school fee deadline come and go. I sat at home while my classmates attended lectures. And on graduation day, I wasn't on the stage with them.

Here's the part that still keeps me up at night: **I had the skills to earn the money I needed the entire time.** I've been shipping code in React and Python since 2022. But I didn't know DevPost existed. I'd never heard of Bug bounties. I had no idea that students like me were winning $5,000+ in weekend hackathons. Not because these opportunities were hidden — they were right there, scattered across dozens of platforms I'd never encountered, with deadlines silently passing me by.

The moment I stumbled onto this ecosystem, something broke inside me. Not anger at any one person, but frustration at a system-level failure: **The information asymmetry**.
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        A student in Ibadan (Nigeria) might not know there's a <strong>$50,000 hackathon</strong> on DevPost that perfectly matches their React skills — <em>deadline tomorrow</em>.
      </p>
      <p>
        A first-generation student in Atlanta might not know about a scholarship designed specifically for their background — <em>applications close in 3 days</em>.
      </p>
      <p>
        Traditional platforms are passive. They wait for you to search. But when you urgently need $500 by Friday, you don't have time to dig through a static database.
      </p>
    </td>
    <td width="50%" valign="top">
      ...
      <ol>
        <li>🔍 <strong>Discovers</strong> opportunities continuously from 40+ platforms using stealth crawlers</li>
...
The result: we reliably crawl **DevPost, DoraHacks, MLH, TAIKAI, HackQuest, intigriti, Devfolio, etc.** — platforms that block most scrapers — using a fleet of stealth Playwright instances with randomised fingerprints and human-like browsing patterns.
...
ScholarStream is fully containerised and deployed to **Google Cloud Run** for elastic, serverless scaling:
